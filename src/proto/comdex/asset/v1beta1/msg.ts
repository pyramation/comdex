...
export const MsgAddAssetRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgAddAssetRequest>, I>>(object: I): MsgAddAssetRequest {
    const message = createBaseMsgAddAssetRequest();
...
export const MsgUpdateAssetRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgUpdateAssetRequest>, I>>(object: I): MsgUpdateAssetRequest {
    const message = createBaseMsgUpdateAssetRequest();
    message.from = object.from ?? "";
...
export const MsgAddPairRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgAddPairRequest>, I>>(object: I): MsgAddPairRequest {
    const message = createBaseMsgAddPairRequest();
    message.from = object.from ?? "";
...
export const MsgAddPairResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgAddPairResponse>, I>>(_: I): MsgAddPairResponse {
    const message = createBaseMsgAddPairResponse();
    return message;
  }
...
export const MsgUpdatePairRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgUpdatePairRequest>, I>>(object: I): MsgUpdatePairRequest {
    const message = createBaseMsgUpdatePairRequest();
    message.from = object.from ?? "";
    message.id = object.id !== undefined && object.id !== null ? Long.fromValue(object.id) : Long.UZERO;
    message.liquidationRatio = object.liquidationRatio ?? "";
...
export const MsgUpdatePairResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgUpdatePairResponse>, I>>(_: I): MsgUpdatePairResponse {
    const message = createBaseMsgUpdatePairResponse();
    return message;
  }
