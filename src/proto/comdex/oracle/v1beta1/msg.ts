...
export const MsgAddMarketRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgAddMarketRequest>, I>>(object: I): MsgAddMarketRequest {
    const message = createBaseMsgAddMarketRequest();
...
export const MsgAddMarketResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgAddMarketResponse>, I>>(_: I): MsgAddMarketResponse {
    const message = createBaseMsgAddMarketResponse();
    return message;
  }
...
export const MsgUpdateMarketRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgUpdateMarketRequest>, I>>(object: I): MsgUpdateMarketRequest {
    const message = createBaseMsgUpdateMarketRequest();
    message.from = object.from ?? "";
    message.symbol = object.symbol ?? "";
    message.scriptId = object.scriptId !== undefined && object.scriptId !== null ? Long.fromValue(object.scriptId) : Long.UZERO;
...
export const MsgUpdateMarketResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgUpdateMarketResponse>, I>>(_: I): MsgUpdateMarketResponse {
    const message = createBaseMsgUpdateMarketResponse();
    return message;
  }
...
export const MsgRemoveMarketForAssetRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgRemoveMarketForAssetRequest>, I>>(object: I): MsgRemoveMarketForAssetRequest {
    const message = createBaseMsgRemoveMarketForAssetRequest();
    message.from = object.from ?? "";
    message.id = object.id !== undefined && object.id !== null ? Long.fromValue(object.id) : Long.UZERO;
    message.symbol = object.symbol ?? "";
...
export const MsgRemoveMarketForAssetResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgRemoveMarketForAssetResponse>, I>>(_: I): MsgRemoveMarketForAssetResponse {
    const message = createBaseMsgRemoveMarketForAssetResponse();
    return message;
  }
...
export const MsgFetchPriceRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgFetchPriceRequest>, I>>(object: I): MsgFetchPriceRequest {
    const message = createBaseMsgFetchPriceRequest();
    message.from = object.from ?? "";
...
export const MsgFetchPriceResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgFetchPriceResponse>, I>>(_: I): MsgFetchPriceResponse {
    const message = createBaseMsgFetchPriceResponse();
    return message;
  }
